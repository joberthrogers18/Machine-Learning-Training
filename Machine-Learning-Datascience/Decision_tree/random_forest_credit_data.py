...
#importanto o algoritmo de arvores aleatórias
from sklearn.ensemble import RandomForestClassifier
# random state mantém o valor da precisão constante, n_estimator é quantas arvores vai ser geradas
